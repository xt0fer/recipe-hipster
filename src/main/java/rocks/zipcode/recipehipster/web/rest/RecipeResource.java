...
/**
 * REST controller for managing {@link rocks.zipcode.recipehipster.domain.Recipe}.
 */
@RestController
@RequestMapping("/api")
public class RecipeResource {
     ...
     */
    @GetMapping("/recipes")
    public ResponseEntity<List<Recipe>> getAllRecipes(Pageable pageable, @RequestParam(required = false) String filter) {
        if ("post-is-null".equals(filter)) {
            log.debug("REST request to get all Recipes where post is null");
            return new ResponseEntity<>(recipeService.findAllWherePostIsNull(), HttpStatus.OK);
        }

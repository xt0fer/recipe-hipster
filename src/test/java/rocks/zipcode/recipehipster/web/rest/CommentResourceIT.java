...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().contents(DEFAULT_CONTENTS).commentDate(DEFAULT_COMMENT_DATE);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().contents(UPDATED_CONTENTS).commentDate(UPDATED_COMMENT_DATE);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getContents()).isEqualTo(DEFAULT_CONTENTS);
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.contents(UPDATED_CONTENTS).commentDate(UPDATED_COMMENT_DATE);
        ...
        Comment testComment = commentList.get(commentList.size() - 1);
        assertThat(testComment.getContents()).isEqualTo(UPDATED_CONTENTS);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.contents(UPDATED_CONTENTS);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.contents(UPDATED_CONTENTS).commentDate(UPDATED_COMMENT_DATE);

...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).contents(DEFAULT_CONTENTS);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().title(UPDATED_TITLE).contents(UPDATED_CONTENTS);
        return post;
    }
    ...
    void putNewPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).contents(UPDATED_CONTENTS);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).contents(UPDATED_CONTENTS);
